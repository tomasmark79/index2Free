...
public:
    ...
    std::string generateHeaderFile(const std::string& shaderToyCode, 
...
private:
    ...
    std::string convertUniforms(const std::string& code, ShaderTarget target, const ShaderAnalysis& analysis);
    ...
    std::string applyAnalysisBasedFixes(const std::string& code, const ShaderAnalysis& analysis, ShaderTarget target);
    ...
    std::string generateTargetSpecificCode(const std::string& code, ShaderTarget target, const std::string& suffix);
    ...
    std::unordered_map<ShaderTarget, std::unordered_map<std::string, std::string>> functionReplacements;
    ...
    std::unordered_map<ShaderTarget, std::unordered_map<std::string, std::string>> builtinReplacements;
